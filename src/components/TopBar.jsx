...
const TopBar = () => {
  ...
  const [lanLink, setLanLink] = useState("ENG");
      ...
      <div className="flex items-center gap-3">
        <div>
          <a href="https://www.instagram.com/thk.avalos/" target="_blank" rel="noopener noreferrer" className="svg-hover">
            <svg id="uuid-5851f45a-ce4c-4670-bbcc-447e4defaebc" xmlns="http://www.w3.org/2000/svg" width="14px" height="14px" viewBox="0 0 7.7 7.7">
        ...
        <div>
          <a href="#" className="lan-hover flex items-center gap-1 uppercase" onClick={handleLan}>
            {lanLink}
            <svg id="uuid-41740953-bb0c-4ab0-b69d-c06d31763925" xmlns="http://www.w3.org/2000/svg" width="2.3mm" height="1mm" viewBox="0 0 6.5 2.9">
              <g id="uuid-e111909c-357a-4c71-a4d9-a7f1815bb448">
