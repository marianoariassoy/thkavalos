  ...
  return (
    <div className="bg-secondary py-2 flex justify-end items-center text-white px-8 text-sm">
      <div className="flex items-center gap-3">
        <div>
          <a href="http://instagram.com" target="_blank" rel="noopener noreferrer" className="svg-hover">
            <svg id="uuid-5851f45a-ce4c-4670-bbcc-447e4defaebc" data-name="Layer 2" xmlns="http://www.w3.org/2000/svg" width="15px" height="15px" viewBox="0 0 7.7 7.7">
